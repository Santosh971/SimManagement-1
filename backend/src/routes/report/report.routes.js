...
// SIM Report
router.get('/sims', reportValidation, validate, reportController.generateSimReport);

// Recharge Report
router.get('/recharges', reportValidation, validate, reportController.generateRechargeReport);

// Call Log Report
router.get('/calllogs', reportValidation, validate, reportController.generateCallLogReport);
